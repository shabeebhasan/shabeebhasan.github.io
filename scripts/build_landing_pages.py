...
"rag-chatbot-developer": dict(
  ...
  proof=[("ocr-document-intelligence-pipeline", "Document extraction backends",
          "Google Vision and Document AI extraction for a document scanning app, and passport and licence OCR behind a React Native backend."),
...
"ai-app-developer": dict(
  ...
  faq=[("Can you work with our existing codebase?",
        "Yes, and I prefer it. Most of my longest engagements were maintaining and extending someone else's system, including a Laravel API behind a doctor and patient app pair that I built and then extended across three contracts."),
